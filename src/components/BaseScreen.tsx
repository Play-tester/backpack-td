...
export default function BaseScreen({ baseLevel, xp, xpNeeded, permBuffs, pickedBasePerks, hasAcademy, unlockedSpells, gold, wave, onUnlockSpell }: Props) {
  ...
  return (
    <div className="base-screen">
      {/* Sub-tab bar */}
      <div className="base-subtabs">
        <button
          className={`base-subtab${subTab === 'base' ? ' base-subtab--active' : ''}`}
          onClick={() => setSubTab('base')}
        >
          🏰 Base
        </button>
        <button
          className={`base-subtab${subTab === 'academy' ? ' base-subtab--active' : ''}`}
